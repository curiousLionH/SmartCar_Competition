...
void straight() { // 기본주행
    Serial.print("Right : "); Serial.print(ir_sensing(IR_R));
    Serial.print("    Left : "); Serial.println(ir_sensing(IR_L));
    ...
    else (ir_sensing(IR_R) >= detect_ir && ir_sensing(IR_L) >= detect_ir ) {  //차선이 검출되지 않을 경우 직진
